  ...
  return (
    <footer className='bg-gray-900 md:px-36 text-left w-full mt-10'>
      ...
      md:px-0 justify-center gap-10 md:gap-32 py-10 border-b border-white/30'>
        <div className='flex flex-col md:itens-start items-center w-full'>
        ...
        <div className='flex flex-col md:items-start items-center w-full'>
          <h2 className='font-smeibold text-white mb-5'>Company</h2>
      ...
      <p className='py-4 text-center text-xs md:text-sm text-white/60'>Copyright 2025 SkillScape. All Right Resserved</p>
